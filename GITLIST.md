...
## 🔥 Payloads, Cheatsheets & Knowledge Bases

- **[PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings)** — *swisskyrepo*
- **[HackTricks](https://github.com/HackTricks-wiki/hacktricks)** — *HackTricks-wiki*
...
## 🧪 Labs, Practice & Learning

- **[WebGoat](https://github.com/WebGoat/WebGoat)** — *WebGoat*
- **[TryHackMe Roadmap](https://github.com/uttambodara/TryHackMeRoadmap)** — *uttambodara*
- **[THM Room Points](https://github.com/pentestfunctions/thm-room-points)** — *pentestfunctions*
- **[TryHackMe Repository](https://github.com/AfvanMoopen/tryhackme-)** — *AfvanMoopen*

---

## 🚨 CVE Research & Exploits
...
## 🖥️ System, Forensics & OS Tools

- **[MemProcFS Analyzer](https://github.com/LETHAL-FORENSICS/MemProcFS-Analyzer)** — *LETHAL-FORENSICS*
- **[KrbRelayEx](https://github.com/decoder-it/KrbRelayEx)** — *decoder-it*
- **[WSLU (WSL Utilities)](https://github.com/wslutilities/wslu)** — *wslutilities*
- **[Remove Windows AI](https://github.com/zoicware/RemoveWindowsAI)** — *zoicware*
...
- **[Awesome Certificates](https://github.com/PanXProject/awesome-certificates/)** — *PanXProject*
- **[Free Certifications](https://github.com/cloudcommunity/Free-Certifications)** — *cloudcommunity*

---

## 🧠 Research & Utilities

- **[Shannon (Security Graph)](https://github.com/KeygraphHQ/shannon)** — *KeygraphHQ*
- **[SubScape](https://github.com/tools-tensorsecurityacademy/SubScape/)** — *tools-tensorsecurityacademy*
- **[BurpSuite Professional](https://github.com/xiv3r/Burpsuite-Professional)** — *xiv3r*
